...
/* A bug seems to be preventing the custom configuration file from loading.
   (possibly http://sourceforge.net/tracker/index.php?func=detail&aid=1241329&group_id=75348&atid=543653)
   So I'm editing the main config file, making FCKeditor upgrades a little more difficult.
   The original "Default" toolbar is commented out below:
